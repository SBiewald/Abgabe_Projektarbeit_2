...
%
\ArtDerArbeit{Projektarbeit} % "Bachelor" oder "Projekt" wählen
\TitelDerArbeit{Vorbereitungen für automatisierte Softwaretests für Berechnungen von KPIs.}
\AutorDerArbeit{Silvan Biewald}
...
\FirmenBetreuer{Janina Rustaee}
\Bearbeitungszeitraum{24.07.2020 -- 16.11.2020}
\Abgabedatum{16.11.2020}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{Einleitung}
\input{GrundlegendesZumProjekt}
\input{Grundlagenkapitel}
\input{TestvorgängeImProjekt}
\input{Vergleich}
